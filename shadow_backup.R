...
#     " - `split -l 1000 -a 3 {db_name}_{table_name}.sql {db_name}/{table_name}_sql/sql_`,
#     "",
#     "To reconstruct, use:", "",
#     " - `cat {db_name}/{table_name}_sql/sql_* > {db_name}_{table_name}.sql`,
#     " - `sqlite3 new_db.db ".read {db_name}_{table_name}.sql"`,
#     "",
#     "# Origin",
